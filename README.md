...
The Karoo Companion app does not support the Karoo 2. Additionally, the k-breathe app does not appear yet in **Extensions**. Until then, the app needs to be sideloaded via ADB.

For easy-to-follow instructions for both Mac and Windows, see DC Rainmaker's article [How to Sideload Android Apps On Your Hammerhead Karoo 1/2/3](https://www.dcrainmaker.com/2021/02/how-to-sideload-android-apps-on-your-hammerhead-karoo-1-karoo-2.html)
...
The Karoo 2 has an older Android runtime and BLUETOOTH_SCAN and BLUETOOTH_CONNECT permissions are not available to be set. The `k-breathe` app runs fine without them.

#### Pair the Sensor

1. On the Karoo, go to **Sensors**.
1. Tap '+', then across the top, tap **Extensions** and pick Tymewear.
